        ...
        <>
            <nav class = { navbar ? "main_navbar nav_active" : "main_navbar"}>
                ...
                <div className = {navbar ? "right_menu nav_active":  "right_menu"}>
                    ...
                    <h1 className = {navbar? "heading1 nav_active": "heading1"}>123-456-7890</h1>
                    <h1 className = {navbar ? "heading2 nav_active": "heading2"}>{`${number_of_items} items - $ ${total_amount}`}</h1>
